...
function Explorer(s){
  ...
  var aStep=TWO_PI/n;
  for(var i=0; i<n; i++){
    productOptions.push(new ExploreProduct(origin,createVector(cos(offsetA+i*aStep)*s*2, sin(offsetA+i*aStep)*s*2, s*0.5)));
  }

  function ExploreProduct(origin,offset,s){
    this.show=function(){
